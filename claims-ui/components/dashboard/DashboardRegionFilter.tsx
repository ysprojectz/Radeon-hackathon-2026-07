      ...
      <DropdownMenuTrigger asChild>
        ...
        >
          <span className="text-base leading-none">
            {MARKET_FLAGS[marketRegion] ?? "🇮🇳"}
          </span>
          <span className="text-sm font-bold uppercase tracking-widest text-white/80">
            {MARKET_LABELS[marketRegion] ?? "India"}
          </span>
          <span className="rounded-full border border-[var(--status-info)]/20 bg-[var(--status-info)]/10 px-2 py-1 text-[10px] font-black text-[var(--status-info)]">
            {displayCurrency}
          </span>
